...
class vector {
  ...
  using const_reverse_iterator = Iterator<typename std::vector<T>::const_reverse_iterator>;
  ...
  auto crbegin() const {
    return const_reverse_iterator(impl.crbegin(), this);
  }

  auto crend() const {
    return const_reverse_iterator(impl.crend(), this);
  }
